...
def login_page():
    """Renders a clean, centered login layout before accessing inventory data."""
    st.markdown("""
        <style>
    ...
    with col_center:
        ...
        with st.form("login_form", clear_on_submit=False):
            ...
            # if submit:
            #     # Replace with your production credentials or environment secrets
...
# Stop script processing if user is unauthenticated
